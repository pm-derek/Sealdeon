...
PRODUCT_TYPE_PATTERNS: list[tuple[str, list[list[str]], list[str]]] = [
    ...
    ("UPC",                  [["ultra-premium collection", "ultra premium collection"]], ["case"]),
    ("PKC ETB",              [["pokemon center"], ["elite trainer box"]], []),
    ("ETB",                  [["elite trainer box"]], []),
    ("Mini Tin Display",     [["mini tin"], ["display"]], ["case"]),
    ("Booster Bundle",       [["booster bundle"]], []),
    ("SPC",                  [["super-premium collection", "super premium collection"]], ["case"]),
    ("Enhanced Booster Box", [["enhanced booster", "enhanced expansion"], ["box"]], ["case"]),
    ...
    ("Binder Collection",    [["binder collection"]], ["case"]),
    ("Poster Collection",    [["poster collection"]], ["case"]),
    ("Premium Collection",   [["premium collection"]], ["ultra", "super", "case"]),
    ("Special Collection",   [["special collection"]], ["case"]),
    ("Build & Battle",       [["build & battle", "build and battle"]], ["case"]),
    ("3-Pack Blister",       [["3-pack blister", "3 pack blister", "three pack blister", "triple pack blister"]], ["case"]),
    ("Surprise Box",         [["surprise box"]], ["case"]),
    ("Tin",                  [["tin"]], ["mini tin", "display", "case"]),
]
